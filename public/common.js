...
window.EL = (() => {
  const STR = {
    es: {
      ...
      viewOrder: 'Ver orden', add: 'Añadir', addToOrder: 'Añadir', basePrice: 'Precio', extrasCost: 'Extras', update: 'Actualizar', soldOut: 'Agotado',
    ...
    en: {
      ...
      viewOrder: 'View order', add: 'Add', addToOrder: 'Add', basePrice: 'Price', extrasCost: 'Extras', update: 'Update', soldOut: 'Sold out',
