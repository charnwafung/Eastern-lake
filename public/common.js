...
window.EL = (() => {
  const STR = {
    es: {
      ...
      viewOrder: 'Ver orden', add: 'Añadir', addToOrder: 'Añadir', basePrice: 'Precio', extrasCost: 'Extras', update: 'Actualizar', soldOut: 'Agotado', notAvailable: 'No disponible', each: 'c/u',
    ...
    en: {
      ...
      viewOrder: 'View order', add: 'Add', addToOrder: 'Add', basePrice: 'Price', extrasCost: 'Extras', update: 'Update', soldOut: 'Sold out', notAvailable: 'Not available', each: 'each',
