...
window.EL = (() => {
  const STR = {
    es: {
      ...
      comboNote: 'Con arroz frito o blanco, y papas o tostones (+$2.50), o solo', miniNote: 'Con arroz frito, papas, arroz blanco o tostones', vegNote: 'Vegetales mixtos o brócoli',
      ...
      viewOrder: 'Ver orden', add: 'Añadir', addToOrder: 'Añadir', basePrice: 'Precio', extrasCost: 'Extras', update: 'Actualizar', soldOut: 'Agotado', notAvailable: 'No disponible', bestTitle: 'Los más pedidos', prev: 'Anterior', next: 'Siguiente', bestTag: 'Más pedido', each: 'c/u',
    ...
    en: {
      ...
      comboNote: 'With fried or white rice, and fries or tostones (+$2.50), or plain', miniNote: 'With fried rice, fries, white rice or tostones', vegNote: 'Mixed vegetables or broccoli',
      ...
      viewOrder: 'View order', add: 'Add', addToOrder: 'Add', basePrice: 'Price', extrasCost: 'Extras', update: 'Update', soldOut: 'Sold out', notAvailable: 'Not available', bestTitle: 'Most popular', prev: 'Previous', next: 'Next', bestTag: 'Popular', each: 'each',
